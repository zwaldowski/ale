...
struct OrderedDictionarySlice<Key: Hashable, Value>: RandomAccessCollection {
    ...
    func makeIterator() -> LazyMapIterator<IndexingIterator<ArraySlice<Key>>, Element> {
    ...
    subscript(range: Range<Int>) -> OrderedDictionarySlice<Key, Value> {
...
extension OrderedDictionary: RandomAccessCollection {
    ...
    func makeIterator() -> LazyMapIterator<IndexingIterator<[Key]>, Element> {
        return keys.lazy.map { ($0, self.elements[$0]!.1) }.makeIterator()
    }
...
extension OrderedDictionary {
    ...
    ///     // Prints "Japan"
    ///     // Prints "Ghana"
    var values: LazyMapCollection<[Key], Value> {
...
extension OrderedDictionary: ExpressibleByDictionaryLiteral {
    ...
    init(dictionaryLiteral list: (Key, Value)...) {
